...
class CombatHUD extends FlxTypedGroup<FlxSprite>
{
	...
	public function new()
	{
		...
		background = new FlxSprite().makeGraphic(180, 180, FlxColor.WHITE);
		background.drawRect(1, 1, 178, 78, FlxColor.BLACK);
		background.drawRect(1, 80, 178, 99, FlxColor.BLACK);
		...
		choices = new Map();
		choices[FIGHT] = new FlxText(background.x + 45, background.y + 95, 85, "FIGHT", 22);
