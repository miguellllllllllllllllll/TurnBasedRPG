...
HXLINE( 325)				_hx_tmp5 = ::hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 325)				_hx_tmp5 = false;
            			}
HXDLIN( 325)			if (_hx_tmp5) {
HXLINE( 325)				 ::openfl::display::Graphics _hx_tmp6 = this->_hx___graphics;
HXDLIN( 325)				_hx_tmp4 = _hx_tmp6->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
HXLINE( 325)				_hx_tmp4 = false;
            			}
HXDLIN( 325)			if (_hx_tmp4) {
HXLINE( 327)				bool _hx_tmp7;
HXDLIN( 327)				if (::hx::IsNotNull( stack )) {
HXLINE( 327)					if (interactiveOnly) {
HXLINE( 327)						_hx_tmp7 = this->mouseEnabled;
            					}
            					else {
HXLINE( 327)						_hx_tmp7 = true;
            					}
            				}
            				else {
HXLINE( 327)					_hx_tmp7 = false;
            				}
HXDLIN( 327)				if (_hx_tmp7) {
