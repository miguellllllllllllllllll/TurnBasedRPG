...
HX_LOCAL_STACK_FRAME(_hx_pos_813c730f1cce36dc_166_addAnimation,"flixel.addons.tile.FlxTileSpecial","addAnimation",0xc259e541,"flixel.addons.tile.FlxTileSpecial.addAnimation","flixel/addons/tile/FlxTileSpecial.hx",166,0x5033d72d)
HX_LOCAL_STACK_FRAME(_hx_pos_813c730f1cce36dc_175_fromSpriteAnimation,"flixel.addons.tile.FlxTileSpecial","fromSpriteAnimation",0xb09aef17,"flixel.addons.tile.FlxTileSpecial.fromSpriteAnimation","flixel/addons/tile/FlxTileSpecial.hx",175,0x5033d72d)
HX_LOCAL_STACK_FRAME(_hx_pos_813c730f1cce36dc_183_getMatrix,"flixel.addons.tile.FlxTileSpecial","getMatrix",0x98cffc19,"flixel.addons.tile.FlxTileSpecial.getMatrix","flixel/addons/tile/FlxTileSpecial.hx",183,0x5033d72d)
HX_LOCAL_STACK_FRAME(_hx_pos_813c730f1cce36dc_211_set_frames,"flixel.addons.tile.FlxTileSpecial","set_frames",0xdaee8f01,"flixel.addons.tile.FlxTileSpecial.set_frames","flixel/addons/tile/FlxTileSpecial.hx",211,0x5033d72d)
HX_LOCAL_STACK_FRAME(_hx_pos_813c730f1cce36dc_223_set_currTileId,"flixel.addons.tile.FlxTileSpecial","set_currTileId",0x581f5c16,"flixel.addons.tile.FlxTileSpecial.set_currTileId","flixel/addons/tile/FlxTileSpecial.hx",223,0x5033d72d)
...
HXLINE(  84)			 ::flixel::addons::tile::FlxTileSpecial _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  84)			_hx_tmp1->_frameTimer = (_hx_tmp1->_frameTimer + elapsed);
...
void FlxTileSpecial_obj::addAnimation(::Array< int > tiles,::hx::Null< Float >  __o_frameRate,::Array< ::Dynamic> framesData){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_813c730f1cce36dc_166_addAnimation)
HXDLIN( 166)		this->animation =  ::flixel::addons::tile::FlxTileAnimation_obj::__alloc( HX_CTX ,HX_("tileAnim",5f,ac,77,7a),tiles,frameRate,true,framesData);
            	}
...
void FlxTileSpecial_obj::fromSpriteAnimation( ::flixel::animation::FlxAnimation anim){
            	HX_GC_STACKFRAME(&_hx_pos_813c730f1cce36dc_175_fromSpriteAnimation)
HXDLIN( 175)		::String anim1 = anim->name;
HXDLIN( 175)		 ::Dynamic _hx_tmp = ::Reflect_obj::field(anim,HX_("_frames",45,c1,fc,1a));
HXDLIN( 175)		this->animation =  ::flixel::addons::tile::FlxTileAnimation_obj::__alloc( HX_CTX ,anim1,( (::Array< int >)(_hx_tmp) ),anim->frameRate,anim->looped,null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTileSpecial_obj,fromSpriteAnimation,(void))
 ...
 ::flixel::math::FlxMatrix FlxTileSpecial_obj::getMatrix(){
            	HX_STACKFRAME(&_hx_pos_813c730f1cce36dc_183_getMatrix)
HXLINE( 184)		this->_tmp_flipH = this->flipX;
HXLINE( 185)		this->_tmp_flipV = this->flipY;
HXLINE( 186)		this->_tmp_rot = this->rotate;
HXLINE( 188)		if (::hx::IsNotNull( this->_currAnimParam )) {
HXLINE( 190)			this->_tmp_flipH = ( (bool)(this->_currAnimParam->__Field(HX_("flipX",0b,45,92,02),::hx::paccDynamic)) );
HXLINE( 191)			this->_tmp_flipV = ( (bool)(this->_currAnimParam->__Field(HX_("flipY",0c,45,92,02),::hx::paccDynamic)) );
HXLINE( 192)			this->_tmp_rot = ( (int)(this->_currAnimParam->__Field(HX_("rotate",5b,46,20,cb),::hx::paccDynamic)) );
            		}
HXLINE( 195)		int rotation = 0;
HXLINE( 196)		if ((this->_tmp_rot == 1)) {
HXLINE( 198)			rotation = 90;
            		}
            		else {
HXLINE( 200)			if ((this->_tmp_rot == 2)) {
HXLINE( 202)				rotation = -90;
            			}
            		}
HXLINE( 205)		this->currFrame->prepareMatrix(this->_matrix,rotation,this->_tmp_flipH,this->_tmp_flipV);
HXLINE( 207)		return this->_matrix;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTileSpecial_obj,getMatrix,return )
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxTileSpecial_obj::set_frames( ::flixel::graphics::frames::FlxFramesCollection value){
            	HX_STACKFRAME(&_hx_pos_813c730f1cce36dc_211_set_frames)
HXLINE( 212)		this->frames = value;
HXLINE( 214)		if (::hx::IsNotNull( value )) {
HXLINE( 216)			this->currFrame = this->frames->frames->__get(this->currTileId).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            		}
HXLINE( 219)		return this->frames;
            	}
...
int FlxTileSpecial_obj::set_currTileId(int value){
            	HX_STACKFRAME(&_hx_pos_813c730f1cce36dc_223_set_currTileId)
HXLINE( 224)		if (::hx::IsNotNull( this->frames )) {
HXLINE( 226)			this->currFrame = this->frames->frames->__get(value).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            		}
HXLINE( 229)		return (this->currTileId = value);
            	}
