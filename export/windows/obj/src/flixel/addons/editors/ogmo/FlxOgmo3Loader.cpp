...
HXDLIN(  45)		return ::Reflect_obj::field( ::Dynamic(this->level->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)),value);
            	}
...
HXDLIN( 135)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
...
HXDLIN( 139)				int _g3 = ( (::Array< ::Dynamic>)(gridLayer1->__Field(HX_("grid2D",18,c0,23,18),::hx::paccDynamic)) )->length;
HXDLIN( 139)				while((_g2 < _g3)){
HXLINE( 139)					_g2 = (_g2 + 1);
HXDLIN( 139)					int j = (_g2 - 1);
HXLINE( 140)					{
HXLINE( 140)						int _g4 = 0;
HXDLIN( 140)						int _g5 = ( (::Array< ::String >)( ::Dynamic(gridLayer1->__Field(HX_("grid2D",18,c0,23,18),::hx::paccDynamic))->__GetItem(j)) )->length;
HXDLIN( 140)						while((_g4 < _g5)){
HXLINE( 140)							_g4 = (_g4 + 1);
HXDLIN( 140)							int i1 = (_g4 - 1);
HXLINE( 142)							if (!(out->exists(( (::String)( ::Dynamic(gridLayer1->__Field(HX_("grid2D",18,c0,23,18),::hx::paccDynamic))->__GetItem(j)->__GetItem(i1)) )))) {
HXLINE( 143)								out->set(( (::String)( ::Dynamic(gridLayer1->__Field(HX_("grid2D",18,c0,23,18),::hx::paccDynamic))->__GetItem(j)->__GetItem(i1)) ),::Array_obj< ::Dynamic>::__new(0));
            							}
HXLINE( 144)							::Array< ::Dynamic> _hx_tmp1 = ( (::Array< ::Dynamic>)(out->get( ::Dynamic(gridLayer1->__Field(HX_("grid2D",18,c0,23,18),::hx::paccDynamic))->__GetItem(j)->__GetItem(i1))) );
HXDLIN( 144)							Float x1 = ( (Float)((i1 * ( (int)(gridLayer1->__Field(HX_("gridCellWidth",5e,d9,40,2d),::hx::paccDynamic)) ))) );
HXDLIN( 144)							Float y1 = ( (Float)((j * ( (int)(gridLayer1->__Field(HX_("gridCellHeight",8f,d1,cc,21),::hx::paccDynamic)) ))) );
HXDLIN( 144)							 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 144)							point1->_inPool = false;
HXDLIN( 144)							_hx_tmp1->push(point1);
            						}
            					}
            				}
            			}
...
HXLINE( 194)				{
HXLINE( 194)					 ::flixel::math::FlxBasePoint this1 = s->offset;
HXDLIN( 194)					Float x = (s->get_width() / ( (Float)(2) ));
HXDLIN( 194)					Float y = (s->get_height() / ( (Float)(2) ));
HXDLIN( 194)					this1->set_x(x);
HXDLIN( 194)					this1->set_y(y);
            				}
