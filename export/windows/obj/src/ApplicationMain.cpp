...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TurnBasedRPG",33,d2,d9,a2),::ApplicationMain_obj::create_dyn());
...
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TurnBasedRPG",33,d2,d9,a2));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TurnBasedRPG",33,d2,d9,a2));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.haxeflixel.turnBasedRPG",d2,03,a1,ee));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TurnBasedRPG",33,d2,d9,a2))
